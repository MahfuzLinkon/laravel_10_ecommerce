                    ...
                    <div class="product-details">
                        ...
                        <div>
                            ...
                            @if($product->discount_percentage)
                                <h3 class="product-price">&#2547;{{ $product->discount_price }}.00 <del class="product-old-price">&#2547;{{ $product->price }}.00</del></h3>
                            @else
                                <h3 class="product-price">&#2547;{{ $product->price }}.00 </h3>
                            @endif
                        ...
                        <div class="product-options">
                            <label>
                                ...
                                <select class="input-select">
                                    @foreach(json_decode($product->size->name) as $size)
                            ...
                            <label>
                                Color
                                <select class="input-select">
                                    @foreach(json_decode($product->color->name) as $color)
