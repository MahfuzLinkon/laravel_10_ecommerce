                ...
                <form class="form-horizontal" action="{{ route('categories.update', $category->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea id="textarea2" class="cleditor" name="description" rows="3">{!! $category->description !!}</textarea>
                            </div>
                            @error('description')
                            <div class="controls" style="margin-top: 5px;">
                                <span style="color: red;">{{ $message }}</span>
                        ...
                        <div class="form-actions">
                            <button type="submit" id="editor" class="btn btn-primary">Update Category</button>
                        </div>
                    </fieldset>
                </form>
            </div>
