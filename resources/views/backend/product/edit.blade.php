                ...
                <form class="form-horizontal" action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" style="width: 503px" value="{{ $product->name }}" class="input-xlarge span5" name="name" >
                            </div>
                            @error('name')
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" style="width: 503px" value="{{ $product->code }}" class="input-xlarge span5" name="code" >
                            </div>
                            @error('code')
                            <div class="controls" style="margin-top: 5px;">
                                <span style="color: red;">{{ $message }}</span>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea id="textarea2" class="cleditor" name="description" rows="3">{!! $product->description !!}</textarea>
                            </div>
                            @error('description')
                            <div class="controls" style="margin-top: 5px;">
                                <span style="color: red;">{{ $message }}</span>
